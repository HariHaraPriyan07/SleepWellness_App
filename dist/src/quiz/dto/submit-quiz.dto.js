...
exports.QuizResultResponseDto = exports.SubmitQuizDto = exports.QuizAnswerDto = void 0;
...
__decorate([
    ...
    (0, class_validator_1.IsNumber)(),
    __metadata("design:type", Number)
], QuizAnswerDto.prototype, "score", void 0);
class SubmitQuizDto {
}
...
__decorate([
    ...
    (0, class_validator_1.ArrayMinSize)(4, { message: 'At least 4 questions must be answered' }),
    (0, class_validator_1.ArrayMaxSize)(10, { message: 'Maximum 10 questions allowed' }),
